...
local t = Def.ActorFrame {
	Def.Quad {
		...
		Next8Command=cmd(decelerate,40/170;zoomtoheight,tonumber(string.sub(shutters[9],1,1))*sh*0.2;sleep,40/170;queuecommand,'Stop');
	...
	Def.Quad {
		...
		Next8Command=cmd(decelerate,40/170;zoomtoheight,tonumber(string.sub(shutters[9],2,2))*sh*0.2;sleep,40/170;queuecommand,'Stop');
		StopCommand=cmd(sleep,0;diffusealpha,0;stoptweening;);
	};
	Def.Quad {
		...
		Next8Command=cmd(decelerate,40/170;zoomtoheight,tonumber(string.sub(shutters[9],3,3))*sh*0.2;sleep,40/170;queuecommand,'Stop');
		StopCommand=cmd(sleep,0;diffusealpha,0;stoptweening;);
	};
	Def.Quad {
		...
		Next8Command=cmd(decelerate,40/170;zoomtoheight,tonumber(string.sub(shutters[9],4,4))*sh*0.2;sleep,40/170;queuecommand,'Stop');
		StopCommand=cmd(sleep,0;diffusealpha,0;stoptweening;);
	};
	Def.Quad {
		...
		Next8Command=cmd(decelerate,40/170;zoomtoheight,tonumber(string.sub(shutters[9],5,5))*sh*0.2;sleep,40/170;queuecommand,'Stop');
		StopCommand=cmd(sleep,0;diffusealpha,0;stoptweening;);
	};
};
