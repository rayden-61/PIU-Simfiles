...
local t = Def.ActorFrame {
	...
	Def.Quad {
		...
		ExpandCommand=cmd(sleep,1.5*(15/170);decelerate,0.3;zoomtoheight,sh*0.2;sleep,20;decelerate,0.3;zoomtoheight,0;queuecommand,'Stop');
		StopCommand=cmd(sleep,0;diffusealpha,0;stoptweening;);
	};
	Def.Quad {
	...
	Def.Quad {
		...
		ExpandCommand=cmd(sleep,0.5*(15/170);decelerate,0.3;zoomtoheight,sh*0.2;sleep,20;decelerate,0.3;zoomtoheight,0;queuecommand,'Stop');
		StopCommand=cmd(sleep,0;diffusealpha,0;stoptweening;);
	};
	Def.Quad {
