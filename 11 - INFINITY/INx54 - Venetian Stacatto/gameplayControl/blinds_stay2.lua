...
local t = Def.ActorFrame {
	Def.Quad {
		...
		ExpandCommand=cmd(sleep,2*(15/170);decelerate,0.3;zoomtoheight,sh*0.2;sleep,999;decelerate,0.3;zoomtoheight,0;queuecommand,'Stop');
	...
	Def.Quad {
		...
		ExpandCommand=cmd(sleep,1*(15/170);decelerate,0.3;zoomtoheight,sh*0.2;sleep,999;decelerate,0.3;zoomtoheight,0;queuecommand,'Stop');
		StopCommand=cmd(sleep,0;diffusealpha,0;stoptweening;);
	};
	Def.Quad {
	...
	Def.Quad {
		...
		ExpandCommand=cmd(sleep,0*(15/170);decelerate,0.3;zoomtoheight,sh*0.2;sleep,999;decelerate,0.3;zoomtoheight,0;queuecommand,'Stop');
		StopCommand=cmd(sleep,0;diffusealpha,0;stoptweening;);
	};
};
