...
local t = Def.ActorFrame {
	...
	Def.Quad {
		OnCommand=cmd(x,cenx;y,sh*0.3;zoomtowidth,sw;diffuse,White;queuecommand,'Expand');
	...
	Def.Quad {
		OnCommand=cmd(x,cenx;y,sh*0.7;zoomtowidth,sw;diffuse,White;queuecommand,'Expand');
