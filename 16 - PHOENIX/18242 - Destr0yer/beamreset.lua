...
t[#t+1] = Def.ActorFrame {
	OnCommand=function(self)
		...
		local P2 = SCREENMAN:GetTopScreen():GetChild('PlayerP2');
			if (ratio > 1.5) then
				if P1 then P1:x(math.floor(sw*.50));P1:y(math.floor(sh*.00));P1:rotationz(00); end
				if P2 then P2:x(math.floor(sw*.50));P2:y(math.floor(sh*.00));P2:rotationz(00); end
				
			else
			
		if P1 then P1:x(math.floor(sw*.50));P1:y(math.floor(sh*.00));P2:rotationz(00); end
		if P2 then P2:x(math.floor(sw*.50));P2:y(math.floor(sh*.00));P2:rotationz(00); end
