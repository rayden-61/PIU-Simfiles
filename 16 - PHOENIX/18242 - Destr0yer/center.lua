...
if GAMESTATE:IsSideJoined(PLAYER_1) and GAMESTATE:GetCurrentSteps(PLAYER_1):GetAuthorCredit() == "EXC" then
	P1IsQuest = true;
end;

if GAMESTATE:IsSideJoined(PLAYER_2) and GAMESTATE:GetCurrentSteps(PLAYER_2):GetAuthorCredit() == "EXC" then
	P2IsQuest = true;
end;
...
t[#t+1] = Def.ActorFrame {
	OnCommand=function(self)
		...
		if P1 then P1:x(math.floor(sw*.50)); end
		if P2 then P2:x(math.floor(sw*.50)); end
	end;
};
