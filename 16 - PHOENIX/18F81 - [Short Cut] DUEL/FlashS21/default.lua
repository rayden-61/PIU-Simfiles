...
if GAMESTATE:IsSideJoined(PLAYER_1) == true and GAMESTATE:IsSideJoined(PLAYER_2) == true then
	...
	if steps1 == 'S21' and steps2 == 'S21' then
		single = true;
		player = 3;
	end;
	if steps1 == 'S21' and steps2 ~= 'S21' then
	...
	if GAMESTATE:IsSideJoined(PLAYER_1) then
		...
		if steps:GetStepsType() == 'StepsType_Pump_Single' and steps:GetDifficulty() == 'Difficulty_Edit' and steps:GetDescription() == 'S21' then
			single = true;
			player = 1;
		end;
	end;
