...
if GAMESTATE:IsSideJoined(PLAYER_1) and GAMESTATE:GetCurrentSteps(PLAYER_1):GetDescription() == "D16" then
	P1IsQuest = true;
end;

if GAMESTATE:IsSideJoined(PLAYER_2) and GAMESTATE:GetCurrentSteps(PLAYER_2):GetDescription() == "D16" then
	P2IsQuest = true;
end;
